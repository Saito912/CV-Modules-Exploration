...
from cv_module.EMO.basic_modules import get_norm, get_act, ConvNormAct


inplace = True

# 论文讲解
# https://mp.weixin.qq.com/s?__biz=MzI5MDUyMDIxNA==&mid=2247653815&idx=1&sn=6a307058866c10cf2d5c2b46c8a0e854&chksm=ec12744edb65fd58b890421ea0410ac1ce22e41ff747a62524e83ea76db71ccb9309e04a9a64&token=738485724&lang=zh_CN#rd
...
class iRMB(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x + self.se(self.conv_local(x)
                        ) if self.has_skip else self.se(self.conv_local(x))
