...
class SwiftFormerEncoder(nn.Module):
    ...
    def __init__(self, dim, mlp_ratio=4.,
        ...
        self.linear = Mlp(in_features=dim, hidden_features=int(
...
def Stage(dim, index, layers, mlp_ratio=4.,
    ...
    for block_idx in range(layers[index]):
        ...
        if layers[index] - block_idx <= vit_num:
            ...
            blocks.append(ConvEncoder(dim=dim, hidden_dim=int(
                mlp_ratio * dim), kernel_size=3))
